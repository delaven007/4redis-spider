    ...
    for tr in tr_list:
      ...
      if code[-4:]=='0000':
          ...
          if code[:2] in ['11','12','31','50']:
            self.country_list.append([name,code,(code[:2]+'0000')])
          else:
            self.country_list.append([name,code,code[:4]+'00'])
    #执行数据库插入语句
    self.insert_mysql()
